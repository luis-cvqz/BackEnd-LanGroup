...
router.post("/", Authorize(`${Roles.ADMINISTRADOR},${Roles.INSTRUCTOR},${Roles.APRENDIZ}`), interacciones.crear);

// PUT /api/interacciones/{interaccionid}
router.put("/:interaccion", Authorize(`${Roles.ADMINISTRADOR},${Roles.INSTRUCTOR},${Roles.APRENDIZ}`), AuthorizeActualizacion, interacciones.actualizar);
